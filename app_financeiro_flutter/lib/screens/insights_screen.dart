...
class _InsightsScreenState extends State<InsightsScreen> {
  ...
  Future<void> carregarDados() async {
    ...
    try {
      final mlService = MLService(baseUrl: widget.baseUrl, token: widget.token);
      
      final dashboardData = await mlService.obterDashboard();
      final previsoesData = await mlService.obterPrevisoes();
